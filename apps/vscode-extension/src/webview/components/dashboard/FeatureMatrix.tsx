    ...
    <section>
      <div className="dash-section-h">
        ...
        <div className="flex items-center gap-2 text-[11px] text-[var(--vs-text-dim)]">
          <span>
            <span className="dot emerald" /> healthy
          </span>
          <span>
            <span className="dot amber" /> partial
          </span>
          <span>
            <span className="dot red" /> blocked
          </span>
        </div>
      </div>
              ...
              const specTone =
                feature.specStatus === "complete"
                  ...
                  : feature.specStatus === "partial"
                    ...
                    : "var(--ord-red)";
              const tone =
                feature.specStatus === "complete" && feature.tests.failed === 0
                  ? "emerald"
                    ...
                    {feature.tests.total > 0 ? (
                      <>
                        ...
                        {feature.tests.failed > 0 && (
                          <span style={{ color: "var(--ord-red)", marginLeft: 6 }}>
                            ✗{feature.tests.failed}
                          </span>
                        )}
                      </>
                    ) : feature.linkedTests > 0 ? (
                      <span style={{ color: "var(--vs-text-dim)" }}>
                        {feature.linkedTests} linked
                      </span>
                    ) : (
                      "—"
                    )}
                    ...
                    {pct === null ? (
                      ...
                      <div className="pass-bar">
                        <div className="bar" style={{ display: "flex" }}>
                          <span
                            style={{
                              width: `${ratio(feature.tests.passed, feature.tests.total)}%`,
                              background: "var(--ord-emerald)"
                            }}
                          />
                          <span
                            style={{
                              width: `${ratio(feature.tests.failed, feature.tests.total)}%`,
                              background: "var(--ord-red)"
                            }}
                          />
                          <span
                            style={{
                              width: `${ratio(feature.tests.flaky, feature.tests.total)}%`,
                              background: "var(--ord-amber)"
                            }}
                          />
                          <span
                            style={{
                              width: `${ratio(feature.tests.skipped, feature.tests.total)}%`,
                              background: "var(--vs-text-dim)"
                            }}
                          />
                        </div>
                        <span className="num-cell" style={{ width: 36, textAlign: "right" }}>
                          {pct}%
                        </span>
                      </div>
                    )}
