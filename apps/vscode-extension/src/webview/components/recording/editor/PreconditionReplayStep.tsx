...
export function PreconditionReplayStep({ index, name, showConnector }: PreconditionReplayStepProps) {
  return (
      ...
      <div className="min-w-0 flex-1 pb-1">
        <div className="rounded-xl border border-tone-violet/25 bg-tone-violet/5">
          <div className="flex items-center gap-2.5 px-3 py-2.5">
            ...
            <span className="min-w-0 flex-1 truncate text-[12.5px] font-medium text-vs-text" title={name}>
              Replayed: {name}
            </span>
          </div>
