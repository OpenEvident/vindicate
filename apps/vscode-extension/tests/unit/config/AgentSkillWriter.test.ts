...
describe("AgentSkillWriter", () => {
  ...
  it("is idempotent when skill already present", async () => {
    const skillDir = path.join(root, ".cursor", "skills", "vindicate");
  ...
  it("writes Claude Code skill under .claude/skills/vindicate/", async () => {
