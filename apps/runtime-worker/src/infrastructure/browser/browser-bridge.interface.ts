...
export type { CreateContextOptions, CreateContextResult, RecordingEventSource } from "./browser-bridge.types.js";
...
export interface IBrowserBridge {
  ...
  ensureHealthyContext(sessionId: string, options?: CreateContextOptions): Promise<CreateContextResult>;
